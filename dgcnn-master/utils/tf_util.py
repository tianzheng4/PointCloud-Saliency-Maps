...
def pairwise_distance(point_cloud):
  ...
  dim_size = len(point_cloud.get_shape().as_list())
  if dim_size == 4:
...
def get_edge_feature(point_cloud, nn_idx, k=20):
  ...
  point_cloud_neighbors = batch_gather_point(point_cloud, nn_idx)
  #point_cloud_neighbors = tf.batch_gather(point_cloud, nn_idx)  
  #point_cloud_neighbors = tf.gather(point_cloud, nn_idx+idx_)
  point_cloud_central = tf.expand_dims(point_cloud_central, axis=-2) 
  #print(point_cloud_flat, point_cloud_neighbors, nn_idx+idx_)
  point_cloud_central = tf.tile(point_cloud_central, [1, 1, k, 1]) ## BxNxkx3
